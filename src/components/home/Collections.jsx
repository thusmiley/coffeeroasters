    ...
    <section className="w-container px-cx mx-auto flexCenter flex-col my-[120px] md:my-[144px] xl:mt-[136px] xl:mb-50">
      ...
      <div className="md:mt-[-70px] md:max-w-[573px] xl:flex xl:max-w-[100%] xl:mt-[-15px]">
        <div className="mt-[48px] text-center  md:flex md:text-left md:items-center xl:flex-col xl:mr-[30px] xl:mt-0 xl:text-center">
          ...
          <div>
            <h3 className="heading3 mt-6 mb-4 md:mt-0 md:mb-6 xl:mt-[71px] xl:mb-6">Gran Espresso</h3>
        ...
        <div className="mt-[60px] text-center md:flex md:text-left md:items-center xl:flex-col xl:mr-[30px] xl:mt-0 xl:text-center">
          ...
          <div>
            <h3 className="heading3 mt-6 mb-4 md:mt-0 md:mb-6 xl:mt-[71px] xl:mb-6">Planalto</h3>
        ...
        <div className="mt-[60px] text-center md:flex md:text-left md:items-center xl:flex-col xl:mr-[30px] xl:mt-0 xl:text-center">
          ...
          <div>
            <h3 className="heading3 mt-6 mb-4 md:mt-0 md:mb-6 xl:mt-[71px] xl:mb-6">Piccollo</h3>
        ...
        <div className="mt-[60px] text-center md:flex md:text-left md:items-center xl:flex-col xl:mt-0 xl:text-center">
          ...
          <div>
            <h3 className="heading3 mt-6 mb-4 md:mt-0 md:mb-6 xl:mt-[71px] xl:mb-6">Danche</h3>
            <p>Light and flavorful blend with cocoa and black pepper for an intense experience</p>
          </div>
        </div>
      </div>
